    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: CustomSurffixIcon(
            svgIcon: "assets/images/icons/Location point.svg"),
  ...
  TextFormField buildPhoneNumberFormField() {
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        floatingLabelBehavior: FloatingLabelBehavior.always,
        suffixIcon: CustomSurffixIcon(svgIcon: "assets/images/icons/Phone.svg"),
        labelStyle: TextStyle(
            color: myFocusNode.hasFocus ? Colors.white : Colors.white),
      ),
    );
  ...
  TextFormField buildLastNameFormField() {
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        floatingLabelBehavior: FloatingLabelBehavior.always,
        suffixIcon: CustomSurffixIcon(svgIcon: "assets/images/icons/User.svg"),
        labelStyle: TextStyle(
            color: myFocusNode.hasFocus ? Colors.white : Colors.white),
      ),
    );
